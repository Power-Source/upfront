...
class Upfront_Permissions {
	...
	public function get_capability_labels () {
		...
		return apply_filters('upfront-access-permissions-labels', array(
			...
			self::BOOT => __('Kann auf den Editor-Modus zugreifen', 'upfront' ),
			self::LAYOUT_MODE => __('Kann Upfront-Layouts bearbeiten', 'upfront' ),
			self::SINGLEPOST_LAYOUT_MODE => __('Kann Einzelbeitrag-Layout bearbeiten', 'upfront' ),
			self::SINGLEPAGE_LAYOUT_MODE => __('Kann Seiten-Layout bearbeiten', 'upfront' ),
			self::HOME_LAYOUT_MODE => __('Kann Homepage-Layout bearbeiten', 'upfront' ),
			self::ARCHIVE_LAYOUT_MODE => __('Kann Archiv-Layout bearbeiten', 'upfront' ),
			self::UPLOAD => __('Kann Medien hochladen', 'upfront' ),
			self::MODIFY_ELEMENT_PRESETS => __('Kann Element-Voreinstellungen erstellen / bearbeiten', 'upfront' ),
			self::DELETE_ELEMENT_PRESETS => __('Kann Element-Voreinstellungen löschen', 'upfront' ),
			self::SWITCH_ELEMENT_PRESETS => __('Kann zwischen Element-Voreinstellungen wechseln', 'upfront' ),
			self::OPTIONS => __('Kann globale Optionen bearbeiten / speichern <p class="description">(Theme-Farben, Kommentare etc.)</p>', 'upfront' ),
			self::CREATE_POST_PAGE => __('Kann Beiträge & Seiten von Upfront aus erstellen', 'upfront' ),
			self::EDIT => __('Kann bestehende Beiträge & Seiten von allen bearbeiten', 'upfront' ),
			self::EDIT_OWN => __('Kann eigene bestehende Beiträge & Seiten bearbeiten', 'upfront' ),
			self::EMBED => __('Kann Embeds verwenden (Code El, Media Embeds)', 'upfront' ),
			self::RESPONSIVE_MODE => __('Kann Layouts im Responsive-Modus betreten & bearbeiten', 'upfront' ),
			self::MODIFY_RESTRICTIONS => __('Kann Benutzerbeschränkungen bearbeiten', 'upfront' ),
			self::SEE_USE_DEBUG => __('Kann Debug-Steuerelemente sehen / verwenden', 'upfront' ),
		));
	}
