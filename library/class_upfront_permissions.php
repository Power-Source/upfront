...
class Upfront_Permissions {
	...
	public function get_capability_labels () {
		...
		return apply_filters('upfront-access-permissions-labels', array(
			...
			self::BOOT => __('Kann auf den Editor-Modus zugreifen', Upfront::TextDomain ),
			self::LAYOUT_MODE => __('Kann Upfront-Layouts bearbeiten', Upfront::TextDomain ),
			self::SINGLEPOST_LAYOUT_MODE => __('Kann Einzelbeitrag-Layout bearbeiten', Upfront::TextDomain ),
			self::SINGLEPAGE_LAYOUT_MODE => __('Kann Seiten-Layout bearbeiten', Upfront::TextDomain ),
			self::HOME_LAYOUT_MODE => __('Kann Homepage-Layout bearbeiten', Upfront::TextDomain ),
			self::ARCHIVE_LAYOUT_MODE => __('Kann Archiv-Layout bearbeiten', Upfront::TextDomain ),
			self::UPLOAD => __('Kann Medien hochladen', Upfront::TextDomain ),
			self::MODIFY_ELEMENT_PRESETS => __('Kann Element-Voreinstellungen erstellen / bearbeiten', Upfront::TextDomain ),
			self::DELETE_ELEMENT_PRESETS => __('Kann Element-Voreinstellungen löschen', Upfront::TextDomain ),
			self::SWITCH_ELEMENT_PRESETS => __('Kann zwischen Element-Voreinstellungen wechseln', Upfront::TextDomain ),
			self::OPTIONS => __('Kann globale Optionen bearbeiten / speichern <p class="description">(Theme-Farben, Kommentare etc.)</p>', Upfront::TextDomain ),
			self::CREATE_POST_PAGE => __('Kann Beiträge & Seiten von Upfront aus erstellen', Upfront::TextDomain ),
			self::EDIT => __('Kann bestehende Beiträge & Seiten von allen bearbeiten', Upfront::TextDomain ),
			...
			self::RESPONSIVE_MODE => __('Kann Layouts im Responsive-Modus betreten & bearbeiten', Upfront::TextDomain ),
			self::MODIFY_RESTRICTIONS => __('Kann Benutzerbeschränkungen bearbeiten', Upfront::TextDomain ),
