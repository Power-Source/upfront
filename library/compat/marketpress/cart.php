	...
	<section id="mp-cart" class="mp_cart mp_cart-default  mp_cart-editable">
		<div class="mp_cart_item">
			...
			<div class="mp_cart_item_content mp_cart_item_content-price">
				<div class="mp_product_price"><span class="mp_product_price-extended">192.00€<span class="exclusive_tax"> (Inklusive MwSt.)</span></span><span class="mp_product_price-each" itemprop="price">(32,00 € pro Stück) <span class="exclusive_tax"> (Inklusive MwSt.)</span></span></div>
	...
	<section id="mp-cart-meta" class="mp_cart_meta">
		...
		<div id="mp-cart-resume" class="mp_cart_resume">
			<div class="mp_cart_resume_head">
				<h3 class="mp_sub_title">Geschätzte Gesamtsumme</h3>
			</div>
			<div class="mp_cart_resume_item mp_cart_resume_item-product-total"> <span class="mp_cart_resume_item_label">Produktsumme</span> <span class="mp_cart_resume_item_amount">192,00 €</span> </div>
			<!-- end mp_cart_resume_item_product-total -->
			<div class="mp_cart_resume_item mp_cart_resume_item-order-total"> <span class="mp_cart_resume_item_label">Geschätzte Gesamtsumme</span> <span class="mp_cart_resume_item_amount">192,00 €</span> </div>
			<!-- end mp_cart_resume_item-order-total -->
		</div>
		<!-- end mp_cart-resume --> <a href="#" class="mp_button mp_button-continue-shopping mp_button-large">Weiter einkaufen?</a> <a class="mp_button mp_button-checkout mp_button-padlock mp_button-large mp_tooltip" href="#">Zur Kasse</a>
		<div class="mp_tooltip_content">
			<p class="mp-secure-checkout-tooltip-text"><strong>Sicherer Bezahlvorgang</strong><br>Einkaufen ist immer sicher und geschützt.</p>
		</div>
	</section>
	<!-- end mp_cart_meta -->
</form>
