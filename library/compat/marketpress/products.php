	...
	<section class="mp_products_filter">
		<form id="mp-products-filter-form" name="mp_products_filter_form" class="mp_form mp_form-products-filter" method="get">
			<div class="mp_form_fields">
				<div class="mp_form_field mp_products_filter_field mp_products_filter_category" data-placeholder="Produkt Kategorie">
					...
					<select name="product_category" id="mp-product-category" class="mp_select2 select2-offscreen" tabindex="-1" title="">
						<option value="-1" selected="selected">Alle anzeigen</option>
				...
				<div class="mp_form_field mp_products_filter_field mp_products_filter_orderby">
					...
					<select id="mp_sort_orderby" class="mp_select2 select2-offscreen" name="order" tabindex="-1" title="Order By">
						...
						<option value="sales-desc">Beliebtheit (Beliebteste zuerst)</option>
						<option value="sales-asc">Beliebtheit (Weniger beliebt zuerst)</option>
					</select>
				</div>
	...
	<section id="mp-products" class="hfeed mp_products mp_products-list">
			...
			<div itemscope="" itemtype="http://schema.org/Product" class="mp_product mp_product-has-image mp_product-image-alignleft mp_thumbnail">
				...
				<div class="mp_product_details">
					<div class="mp_product_meta">
						...
						<!-- MP Product Price -->
						<div class="mp_product_price" itemtype="http://schema.org/Offer" itemscope="" itemprop="offers"><span class="mp_product_price-normal" itemprop="price">$444.00<span class="exclusive_tax"> (inkl. MwSt.)</span></span></div>
				...
				<div style="display:none"> <span class="entry-title">Produkt 5</span> zuletzt geändert: <time class="updated">2016-11-03T1:16</time> by <span class="author vcard"><span class="fn">admin</span></span> </div>
			</div>
			<!-- end mp_product -->
		</div>
		<!-- end mp_product_item -->
		<div class="mp_product_item">
			<div itemscope="" itemtype="http://schema.org/Product" class="mp_product mp_product-has-image mp_product-image-alignleft mp_thumbnail">
				...
				<!-- end mp_product_details -->
				<div style="display:none"> <span class="entry-title">Produkt 4</span> zuletzt geändert: <time class="updated">2016-11-03T1:15</time> by <span class="author vcard"><span class="fn">admin</span></span> </div>
			</div>
			<!-- end mp_product -->
		</div>
		<!-- end mp_product_item -->
		<div class="mp_product_item">
			<div itemscope="" itemtype="http://schema.org/Product" class="mp_product mp_product-has-image mp_product-image-alignleft mp_thumbnail">
				...
				<!-- end mp_product_details -->
				<div style="display:none"> <span class="entry-title">Produkt 3</span> zuletzt geändert: <time class="updated">2016-11-03T1:15</time> by <span class="author vcard"><span class="fn">admin</span></span> </div>
			</div>
			<!-- end mp_product -->
		</div>
		<!-- end mp_product_item -->
		<div class="mp_product_item">
			<div itemscope="" itemtype="http://schema.org/Product" class="mp_product mp_product-has-image mp_product-image-alignleft mp_thumbnail">
				...
				<!-- end mp_product_details -->
				<div style="display:none"> <span class="entry-title">Produkt 2</span> zuletzt geändert: <time class="updated">2016-11-02T7:04</time> by <span class="author vcard"><span class="fn">admin</span></span> </div>
			</div>
			<!-- end mp_product -->
		</div>
		<!-- end mp_product_item -->
		<div class="mp_product_item">
			<div itemscope="" itemtype="http://schema.org/Product" class="mp_product mp_product-has-image mp_product-image-alignleft mp_thumbnail">
				...
				<!-- end mp_product_details -->
				<div style="display:none"> <span class="entry-title">Produkt 1</span> zuletzt geändert: <time class="updated">2016-11-02T18:57</time> by <span class="author vcard"><span class="fn">admin</span></span> </div>
			</div>
			<!-- end mp_product -->
		</div>
		<!-- end mp_product_item -->
