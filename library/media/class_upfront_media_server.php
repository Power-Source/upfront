...
class Upfront_MediaServer extends Upfront_Server {
	...
	private function _get_l10n ($key=false) {
		$l10n = array(
			...
			'selected_no_label' => __('%s ausgewählt, sie teilen keine gemeinsamen Labels.', 'upfront'),
			...
			'add_labels' => __("Label(s) hinzufügen", 'upfront'),
			'media_labels' => __("Medien-Labels", 'upfront'),
			'current_labels' => __("Aktuelle(r) Label(s)", 'upfront'),
			'additional_sizes' => __("Zusätzliche Größen", 'upfront'),
			'url' => __("URL", 'upfront'),
			'add' => __("+Hinzufügen", 'upfront'),
			'search' => __("Suche", 'upfront'),
			'search_media' => __("Medien durchsuchen", 'upfront'),
			'search_placeholder' => __("Hier eingeben...", 'upfront'),
			'clear_search' => __("Suche löschen", 'upfront'),
			'showing_total_results' => __("Zeige {{total}} Ergebnisse für", 'upfront'),
			'active_filters' => __("Aktive Filter", 'upfront'),
			'filter_label' => __("Medien filtern", 'upfront'),
			'by_type' => __("Nach Typ", 'upfront'),
			'by_labels' => __("Nach Labels", 'upfront'),
			'select_filter' => __("Filter auswählen", 'upfront'),
			...
			'please_select_labels' => __("Bitte, wählen Sie Labels aus...", 'upfront'), // remove
			'filter_by_labels' => __("Filtern nach Labels:", 'upfront'),
			'type_labels' => __("Tippe Labels hier...", 'upfront'),
			'type_labels_pick' => __("Tippe, um Label(s) auszuwählen", 'upfront'),
			'type_labels_add' => __("Tippe, um ein Label zu erstellen", 'upfront'),
			'assigned_labels' => __("Zugewiesene Labels", 'upfront'),
			'create_new_label' => __("Neues Label erstellen", 'upfront'),
			...
			'plain_images' => __('einfache Bilder', 'upfront'),
			'image_slider' => __('Bilder-Slider', 'upfront'),
			...
			'loading_embeddable_preview' => __('Lade einbettbare Vorschau...', 'upfront'),
			'loading_media_files' => __('Lade Mediendateien...', 'upfront'),
			'applied_labels' => __('Zugewiesene Labels:', 'upfront'),
			'video_recommendation_nag' => __('Wir empfehlen die Nutzung von Diensten wie YouTube, Vimeo oder Soundcloud zum Speichern von Rich-Media-Dateien. Diese lassen sich anschließend ganz einfach in Deine Webseite einbinden. Hier erfährst du mehr.', 'upfront'),
			'keep_file' => __('Datei behalten', 'upfront'),
			'remove_file' => __('Datei entfernen', 'upfront'),
			'media_url' => __('URL der Mediendatei', 'upfront'),
			'image_title' => __('Bildtitel', 'upfront'),
			'your_image_title' => __('Dein Bildtitel', 'upfront'),
			'n_of_x' => _x("of", "N von X", 'upfront'),
			...
			'media_labels' => __('Medien-Labels', 'upfront'),
			'media_label' => __('Medien-Label', 'upfront'),
			'disabled' => __('Diese Funktion wurde deaktiviert', 'upfront'),
			'insert_options' => __('Einfügeoptionen', 'upfront'),
			'image_inserts' => __('Bildeinfügungen', 'upfront'),
			'wp_default' => __('WP Standard', 'upfront'),
			'confirm_delete_items' => __("Bist du sicher, dass du die ausgewählten Elemente löschen möchtest?", 'upfront'),
			'on_this_page' => __("auf dieser Seite", 'upfront'),
			'display' => __('Anzeigen', 'upfront'),
