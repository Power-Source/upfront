...
class Upfront_UmapView extends Upfront_Object{
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'preloading_msg' => __('Hier kommt die Karte rein.', 'upfront'),
			'css' => array(
				'label' => __('Map Container', 'upfront'),
				'info' => __('Der Layer, der die Karte umschließt.', 'upfront'),
			),
			'menu' => array(
				'center_map' => __('Karte hier zentrieren', 'upfront'),
				'add_marker' => __('Marker hinzufügen', 'upfront'),
				'remove_marker' => __('Marker entfernen', 'upfront'),
				'change_icon' => __('Symbol ändern', 'upfront'),
			),
			'connectivity_warning' => __('Bitte überprüfe deine Internetverbindung.', 'upfront'),
			'instructions' => __('Adresse eingeben:', 'upfront'),
			'api_key_empty' => __('Gib deinen Google Maps API Key in das Feld ein', 'upfront'),
			'api_key_url' => admin_url('admin.php?page=upfront#api-key-gmaps'),
			'here' => __('hier', 'upfront'),
			'api_key_empty_region' => __('Gib deinen Google Maps API Key im Admin unter dem Upfront-Menü, Untermenü Allgemein ein.', 'upfront'),
			'placeholder' => __('Straße, Stadt, Land', 'upfront'),
			'or' => __('oder', 'upfront'),
			'use_current_location' => __('Meine aktuelle Position verwenden', 'upfront'),
			'hold_on' => __('Bitte warten', 'upfront'),
			'edit_this' => __('Bearbeiten...', 'upfront'),
			'image_url' => __('Bild URL (.png):', 'upfront'),
			'settings' => __('Map Einstellungen', 'upfront'),
			'general_settings' => __('Allgemeine Einstellungen', 'upfront'),
			'address' => __('Adresse:', 'upfront'),
			'label' => __('Google Karte', 'upfront'),
			'location_label' => __('Kartenstandort', 'upfront'),
			'style' => array(
			...
			'ctrl' => array(
				...
				'type' => __('Kartentyp', 'upfront'),
				'scale' => __('Maßstab', 'upfront'),
				'street_view' => __('Straßenansicht', 'upfront'),
				'overview' => __('Übersichtskarte', 'upfront'),
			),
			'zoom_level' => __('Map Zoom Level:', 'upfront'),
			'map_style' => __('Map Stil', 'upfront'),
			'map_controls' => __('Map Kontrollen', 'upfront'),
			'draggable_map' => __('Karte verschiebbar', 'upfront'),
			'hide_markers' => __('Marker ausblenden', 'upfront'),
			'use_custom_map_code' => __('Benutzerdefinierten Karten-Code verwenden', 'upfront'),
			'use_custom_map_code_info' => __('Code, der von Apps wie Snazzy Maps generiert wurde', 'upfront'),
			'open_map_code_panel' => __('Karten-Code-Panel öffnen', 'upfront'),
			'default_script' => __('/* Dein Code hier */', 'upfront'),
			'unable_to_geolocate' => __('Dein aktueller Standort konnte nicht automatisch ermittelt werden.', 'upfront'),
			'create' => array(
				'change' => __('Zum Ändern klicken', 'upfront'),
