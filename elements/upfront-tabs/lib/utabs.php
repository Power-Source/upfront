...
class Upfront_UtabsView extends Upfront_Object {
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'default_tab_content' => __('<p>Klicke auf den aktiven Tab-Titel, um den Titel zu bearbeiten. Bestätige mit der Eingabetaste.</p><p>Klicke auf die Plus-Schaltfläche [+], um einen neuen Tab hinzuzufügen.</p>', 'upfront'),
			'second_tab_content' => __('Habe Spaß mit Tabs.', 'upfront'),
			'tab_label'	=> __('Tab', 'upfront'),
			'content_label'	=> __('Inhalt', 'upfront'),
			'tab_placeholder' => __('Tab-Inhalt', 'upfront'),
			'css' => array(
				'container_label' => __('Tabs Container', 'upfront'),
				'container_info' => __('Die Ebene, die alle Inhalte des Tab-Elements enthält.', 'upfront'),
				'menu_label' => __('Tabs-Menü', 'upfront'),
				'menu_info' => __('Die Zeile, die alle Tabs enthält.', 'upfront'),
				'tabs_label' => __('Tabs', 'upfront'),
				'tabs_info' => __('Jeder der Tabs.', 'upfront'),
				'active_tab_label' => __('Aktiver Tab', 'upfront'),
				'active_tab_info' => __('Aktiver Tab', 'upfront'),
				'tab_content_label' => __('Tab-Inhalt', 'upfront'),
				'tab_content_info' => __('Die Ebene, die den Tab-Inhalt umschließt.', 'upfront'),
				'tab_p_label' => __('Tab-Inhalt Absatz', 'upfront'),
				'tab_p_info' => __('Der Absatz, der den Tab-Inhalt enthält.', 'upfront'),
				'active_content_label' => __('Aktiver Tab-Inhalt', 'upfront'),
				'active_content_info' => __('Die Ebene, die den aktiven Tab-Inhalt umschließt.', 'upfront'),
				'active_p_label' => __('Aktiver Tab-Inhalt Absatz', 'upfront'),
				'active_p_info' => __('Der Absatz, der den aktiven Tab-Inhalt enthält.', 'upfront'),
			),
			'settings' => __('Einstellungen', 'upfront'),
			'add_tab' => __('Einen Tab hinzufügen', 'upfront'),
			'default_preset' => __('Standard', 'upfront'),
			'content_area_colors_label' => __('Farben des Inhaltsbereichs', 'upfront'),
			'content_area_bg_label' => __('Hintergrund des Inhaltsbereichs', 'upfront'),
			'colors_label' => __('Farben', 'upfront'),
			'tab_typography_label' => __('Tab-Beschriftung Typografie', 'upfront'),
