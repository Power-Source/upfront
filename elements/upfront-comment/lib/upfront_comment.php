...
class Upfront_UcommentView extends Upfront_Object {
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'error_permissions' => __('Du kannst dies nicht tun', 'upfront'),
			...
			'avatars' => __('Avatare', 'upfront'),
			'ok' => __('OK', 'upfront'),
			'please_wait' => __('Bitte warten', 'upfront'),
			'avatar_settings' => __('Avatar-Einstellungen', 'upfront'),
			'show_avatars' => __('Avatare anzeigen', 'upfront'),
			'max_rating' => __('Höchstbewertung', 'upfront'),
			'settings' => __('Einstellungen', 'upfront'),
			'main_panel' => __('Haupt', 'upfront'),
			'rating' => array(
				'g' => __('Für alle Altersgruppen geeignet', 'upfront'),
				'pg' => __('Möglicherweise anstößig, normalerweise für Zuschauer ab 13 Jahren', 'upfront'),
				'r' => __('Für erwachsene Zuschauer ab 17 Jahren vorgesehen', 'upfront'),
				'x' => __('Noch reifer als R', 'upfront'),
			),
			'default_avatar' => __('Standard-Avatar', 'upfront'),
			'article' => array(
				'label' => __('Standard-Artikel-Einstellungen', 'upfront'),
				'pingback' => __('Versuche, alle Blogs zu benachrichtigen, die vom Artikel verlinkt sind', 'upfront'),
				'ping_status' => __('Erlaube Link-Benachrichtigungen von anderen Blogs (Pingbacks und Trackbacks)', 'upfront'),
				'comment_status' => __('Erlaube es den Leuten, Kommentare zu neuen Artikeln zu posten<br />(Diese Einstellungen können für einzelne Artikel überschrieben werden.)', 'upfront'),
				'attachments' => __('Erlaube Anhänge in Kommentaren', 'upfront'),
				'email' => __('E-Mail-Abonnementfeld anzeigen', 'upfront'),
			),
			'other' => array(
				'label' => __('Andere Kommentar-Einstellungen', 'upfront'),
				'require_name_email' => __('Kommentator muss Name und E-Mail ausfüllen', 'upfront'),
				'comment_registration' => __('Benutzer müssen registriert und angemeldet sein, um zu kommentieren', 'upfront'),
				'autoclose' => __('Kommentare zu Artikeln, die älter als {{subfield}} Tage sind, automatisch schließen', 'upfront'),
				'thread_comments' => __('Verschachtelte Kommentare bis zu {{subfield}} Ebenen aktivieren', 'upfront'),
				'page_comments' => __('Kommentare nach {{depth}} obersten Kommentaren paginieren und standardmäßig Seite {{page}} anzeigen', 'upfront'),
				...
				'older' => __('ältere', 'upfront'),
				'newer' => __('neuere', 'upfront'),
				'email_me' => __('Sende mir eine E-Mail, wann immer', 'upfront'),
				'comments_notify' => __('Jemand einen Kommentar postet', 'upfront'),
				'moderation_notify' => __('Ein Kommentar wird zur Moderation zurückgehalten', 'upfront'),
				...
				'max_links' => __('Einen Kommentar in der Warteschlange halten, wenn er {{field}} oder mehr Links enthält. (Ein häufiges Merkmal von Kommentar-Spam ist eine große Anzahl von Hyperlinks.)', 'upfront'),
				'moderation_keys' => __('Wenn ein Kommentar eines dieser Wörter in seinem Inhalt, Namen, URL, E-Mail oder IP enthält, wird er in der Moderationswarteschlange gehalten. Ein Wort oder eine IP pro Zeile. Es wird innerhalb von Wörtern übereinstimmen, also wird „press“ mit „WordPress“ übereinstimmen.', 'upfront'),
				'blacklist_keys' => __('Wenn ein Kommentar eines dieser Wörter in seinem Inhalt, Namen, URL, E-Mail oder IP enthält, wird er als Spam markiert. Ein Wort oder eine IP pro Zeile. Es wird innerhalb von Wörtern übereinstimmen, also wird „press“ mit „WordPress“ übereinstimmen.', 'upfront'),
			),
		);
		return !empty($key)
