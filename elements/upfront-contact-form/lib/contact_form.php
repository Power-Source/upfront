...
class Upfront_UcontactView extends Upfront_Object {
	...
	private function check_form_received () {
		...
		if (isset($_POST['ucontact']) && $_POST['ucontact'] == 'sent' && $_POST['contactformid'] == $this->_get_property('element_id')) {
			...
			if ($this->msg) {
				...
				if (!empty($name)) {
					$email_callback = function () use ($email) { return $email; };
					$name_callback = function () use ($name) { return $name; };
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'contact_details' => __('Kontaktdaten', 'upfront'),
			'name_label' => __('Name:', 'upfront'),
			'email_label' => __('Email:', 'upfront'),
			'subject_label' => __('Betreff:', 'upfront'),
			'captcha_label' => __('CAPTCHA:', 'upfront'),
			'default_subject' => __('Von der Webseite gesendet', 'upfront'),
			'message_label' => __('Nachricht:', 'upfront'),
			'button_text' => __('Senden', 'upfront'),
			'unknown_form' => __('Unbekanntes Kontaktformular.', 'upfront'),
			'invalid_data' => __('Die Daten des Kontaktformulars sind ungültig.', 'upfront'),
			'settings_stored' => __('Einstellungen des Kontaktformulars gespeichert.', 'upfront'),
			'store_error' => __('Es gab ein Problem beim Speichern der Einstellungen des Kontaktformulars.', 'upfront'),
			...
			'mail_sent' => __('Die E-Mail wurde erfolgreich gesendet.', 'upfront'),
			'missing_name' => __('Du musst deinen Namen angeben.', 'upfront'),
			'invalid_email' => __('Deine E-Mail-Adresse ist ungültig.', 'upfront'),
			'missing_subject' => __('Du musst einen Betreff für die Nachricht angeben.', 'upfront'),
			'missing_message' => __('Du hast vergessen, die Nachricht zu schreiben.', 'upfront'),
			'css' => array(
				'labels_label' => __('Feldbeschriftungen', 'upfront'),
				'labels_info' => __('Textinformationen für jedes Feld', 'upfront'),
				...
				'err_label' => __('Fehlerhafte Felder', 'upfront'),
				'err_info' => __('Felder mit Fehlern.', 'upfront'),
				'send_label' => __('Absenden-Button', 'upfront'),
				'send_info' => __('Absenden-Button des Formulars', 'upfront'),
			),
			'general' => array(
				'label' => __('Allgemeine Einstellungen', 'upfront'),
				'send_to' => __('Formularinhalt senden an:', 'upfront'),
				'button_text' => __('Text des Absenden-Buttons:', 'upfront'),
				'use_title' => __('Formulartitel verwenden', 'upfront'),
				'form_title' => __('Formulartitel:', 'upfront'),
			),
			'validation' => array(
				'label' => __('Formularvalidierung', 'upfront'),
				'on_field' => __('Inline', 'upfront'),
				'on_submit' => __('Beim Absenden', 'upfront'),
			),
			'fields' => array(
				'label' => __('Formularfelder', 'upfront'),
				'title' => __('Kontaktformularfelder', 'upfront'),
				'name' => __('Name Feld Text:', 'upfront'),
				'email' => __('Email Feld Text:', 'upfront'),
				'msg' => __('Nachrichtenfeld Text:', 'upfront'),
				'show_subject' => __('Betreff Feld', 'upfront'),
				'show_captcha' => __('CAPTCHA', 'upfront'),
				'subject' => __('Betreff Feld Text:', 'upfront'),
				'default_subject' => __('Standard Betreff:', 'upfront'),
				'label_location' => __('Position der Feldbeschriftung:', 'upfront')
			),
			'apr' => array(
				'label' => __('Darstellung', 'upfront'),
				'above' => __('Über dem Feld', 'upfront'),
				'over' => __('Über dem Feld', 'upfront'),
				'inline' => __('Inline mit dem Feld', 'upfront'),
			),
			'settings' => __('Kontaktformular Einstellungen', 'upfront'),
			'colors_label' => __('Farben', 'upfront'),
			'field_bg_label' => __('Feld Hintergrund', 'upfront'),
			...
			'field_button_label' => __('Feld & Button', 'upfront'),
			'field_label' => __('Feld', 'upfront'),
			'template' => array(
				'missing_name' => __('Du musst deinen Namen angeben.', 'upfront'),
				'invalid_email' => __('Deine E-Mail-Adresse ist ungültig.', 'upfront'),
				'missing_subject' => __('Du musst einen Betreff für die Nachricht angeben.', 'upfront'),
				'missing_body' => __('Du hast vergessen, die Nachricht zu schreiben.', 'upfront'),
				'realperson_regenerate' => __('Klicke zum Ändern', 'upfront'),
			),
			'smtp' => array(
				'enable' => __('SMTP aktivieren', 'upfront'),
				...
				'ssl' => __('SSL', 'upfront'),
				'tls' => __('TLS', 'upfront'),
				'port' => __('SMTP Port', 'upfront'),
				'no' => __('Nein', 'upfront'),
				'yes' => __('Ja', 'upfront'),
				'username' => __('Benutzername', 'upfront'),
				'password' => __('Passwort', 'upfront'),
				'configuration' => __('Konfiguration', 'upfront'),
				'secure' => __('SMTP Secure', 'upfront'),
				'authentication' => __('SMTP-Authentifizierung aktivieren', 'upfront')
			)
		);
		return !empty($key)
