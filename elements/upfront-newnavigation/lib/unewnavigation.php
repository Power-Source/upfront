...
class Upfront_UnewnavigationView extends Upfront_Object {
	...
	public static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'select_menu' => __('Bitte wähle das Menü in den Einstellungen aus.', 'upfront'),
			...
			'cant_update_auto' => __('Menü kann nicht automatisch aktualisiert werden', 'upfront'),
			'visit_url' => __('Besuche URL', 'upfront'),
			'edit_url' => __('Bearbeite URL', 'upfront'),
			'edit_label' => __('Bearbeite Bezeichnung', 'upfront'),
			'remove_link' => __('Link entfernen', 'upfront'),
			'link_label' => __('Link-Bezeichnung', 'upfront'),
			'create_dropdown' => __('Drop-Down erstellen', 'upfront'),
			'choose_existing_menu' => __('Bestehendes Menü auswählen', 'upfront'),
			'are_you_sure_nag' => __('Bist du sicher, dass du dieses Menü löschen möchtest?', 'upfront'),
			'css' => array(
				'bar_label' => __('Menüleiste', 'upfront'),
				'bar_info' => __('Menüleiste', 'upfront'),
				'item_label' => __('Menüpunkt', 'upfront'),
				'item_info' => __('Menüpunkt auf oberster Ebene', 'upfront'),
				'hover_label' => __('Menüpunkt Hover', 'upfront'),
				'hover_info' => __('Hover-Zustand für Menüpunkt auf oberster Ebene', 'upfront'),
				'close_info' => __('Symbol zum Schließen der responsiven Navigation', 'upfront'),
				'subitem_label' => __('Untermenüpunkt', 'upfront'),
				'subitem_info' => __('Menüpunkt auf unterer Ebene', 'upfront'),
				'subitem_hover_label' => __('Untermenüpunkt Hover', 'upfront'),
				'subitem_hover_info' => __('Hover-Zustand für Menüpunkt auf unterer Ebene', 'upfront'),
				'responsive_bar_label' => __('Responsive Menüleiste', 'upfront'),
				'responsive_trigger' => __('Responsive Menüauslöser', 'upfront'),
				'responsive_trigger_bars' => __('Responsive Auslöserleisten', 'upfront'),
				'responsive_nav_close' => __('Responsive Schließen-Symbol', 'upfront'),
				'responsive_item_label' => __('Responsive Menüpunkt', 'upfront'),
				'responsive_hover_label' => __('Responsive Menüpunkt Hover', 'upfront'),
				'responsive_subitem_label' => __('Responsive Untermenüpunkt', 'upfront'),
				'responsive_subitem_hover_label' => __('Responsive Untermenüpunkt Hover', 'upfront'),
			),
			'new_menu_name' => __('Gib einen neuen Menünamen ein...', 'upfront'),
			'create_new' => __('Neu erstellen', 'upfront'),
			'link_name' => __('Link-Name', 'upfront'),
			'mnu' => array(
				'label' => __('Menü', 'upfront'),
				'title' => __('Allgemeine Einstellungen', 'upfront'),
				'load' => __('Menü zur Verwendung auswählen', 'upfront'),
				'delete_menu' => __('Löschen', 'upfront'),
				'create' => __('oder Neu erstellen', 'upfront'),
				'use' => __('Verwenden', 'upfront'),
				'btn' => __('Schaltfläche zum Öffnen des Menüs', 'upfront'),
				'appearance' => __('Erscheinungsbild des aufgedeckten Menüs', 'upfront'),
				'show_on_click' => __('Menü anzeigen beim Klicken auf Standort:', 'upfront'),
				'alignment' => __('Ausrichtung:', 'upfront'),
				'aligh' => __('Ausrichtung der Menüpunkte', 'upfront'),
				...
				'push' => __('Inhalt verschieben', 'upfront'),
				'align' => __('Ausrichtung der Menüpunkte', 'upfront'),
				'style' => __('Menü Stil:', 'upfront'),
				...
				'float' => __('Dieses Menü floaten', 'upfront'),
			),
			'panel' => array(
				'menu_kind_label' => __('Menü Kind', 'upfront'),
				'typography_label' => __('Typografie', 'upfront'),
				'colors_label' => __('Farben', 'upfront'),
				'background_label' => __('Hintergrund', 'upfront'),
				'item_background_label' => __('Hintergrund des Menüpunkts', 'upfront'),
			),
