...
[![Version](https://img.shields.io/badge/Version-1.2.6-2271b1?style=flat-square)](readme.txt)
...
| `./scripts/build-i18n.sh` | POT neu generieren, PO aktualisieren und MO kompilieren |
